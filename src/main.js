        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch_1("http://api.giphy.com/v1/gifs/random?tag=cat", {
                            headers: {
                ...
                case 2:
                    ...
                    octokit.issues.createComment(__assign(__assign({}, context.repo), { issue_number: pullRequestNumber, body: message }));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.log("test 2");
